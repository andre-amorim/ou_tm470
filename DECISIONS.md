...
- [2026-07-13 13:40] Restructured Section 8 (LO7: Reviewing the Project) of the TMA03 dissertation draft (v4.0) to frame the narrative evolution from a highly technical documentation geared towards specialists to an academic-friendly translation layer. Weaved in TM353 stakeholder success criteria (Davis, 2013; Fortune et al., 2011) and TM354 Block 1 audience consideration and documentation requirements to align with tutor expectations and show academic traceability.
