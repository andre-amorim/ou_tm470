...
Looking back over the project lifecycle from TMA01 to the present, the most fundamental evolution has not been in the codebase, but in how the project is communicated. Initially, the project's documentation was highly technical, geared towards a niche audience of Nix and Bitcoin specialists. Feedback from TMA01 and TMA02 revealed a significant gap in this approach: while the technical implementation was sound, the academic framing—such as clear deliverable definitions and resource identification—was getting lost in the technical jargon.

This academic misalignment can be analyzed through the lens of **TM353 (IT Project Success)**, which establishes that a system's success is not singular, but is multi-dimensional and defined by the perspectives of its diverse **stakeholders** (Davis, 2013; Fortune et al., 2011). While the project was a success from a **software engineering** perspective—delivering high-quality, reproducible code—it risked failing the academic stakeholders (the tutor and examiners) because the documentation lacked the necessary framing. As emphasized in **TM354 Block 1**, developers must *'always consider the intended audience for any document that you produce'* (The Open University, 2022). In academic software engineering, the codebase is a *'necessary but not a sufficient deliverable'* to trace development history; documentation must provide the academic **traceability** that allows stakeholders to reconstruct significant design decisions and their underlying rationale.

### 8.1 Software as Storytelling

Recognising that technical excellence means little if it cannot be effectively communicated to a broader audience, the overarching strategy for the TM470 module was completely revised. As I noted in a recent correspondence with my tutor regarding TMA03 feedback, I have embraced the philosophy that "software is storytelling."

This concept, explored by Hugo Liu and Henry Lieberman in their 2005 MIT Media Lab research, argues that programming is inherently a narrative form, where data structures act as nouns, functions as verbs, and properties as adjectives. Moving forward, the project's primary focus shifted from simply building the infrastructure to telling the story of the "Reproducibility Gap" through appropriate **abstraction** — focusing the narrative on high-level environmental constraints rather than overwhelming compiler syntax. This realization informed the restructuring of this report around accessible analogies (such as the "Jenga Tower" of configuration drift), translating the technical **domain model** into clear, stakeholder-friendly **requirements** and **use cases**, and ensuring all TM354 terminology is clearly contextualized.
