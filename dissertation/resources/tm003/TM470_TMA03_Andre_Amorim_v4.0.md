...
Recognising that technical excellence means little if it cannot be effectively communicated to a broader audience, the overarching strategy for the TM470 module was completely revised. I have embraced the philosophy that "software is storytelling."

This transition aligns directly with software engineering principles taught in **TM354 Block 1**, which reminds developers to *'always consider the intended audience for any document that you produce'* (The Open University, 2022). As Hugo Liu and Henry Lieberman (2005) argued in their MIT Media Lab research, programming is inherently a narrative form, where data structures act as nouns, functions as verbs, and properties as adjectives. Moving forward, the project's primary focus shifted from simply building the infrastructure to telling the story of the "Reproducibility Gap" through appropriate **abstraction** — focusing the narrative on high-level environmental constraints rather than overwhelming compiler syntax.

Furthermore, this narrative shift addresses the core teachings of **TM353 (IT Project Success)** on stakeholder alignment (Davis, 2013; Fortune et al., 2011). While the project was successful from a pure **software engineering perspective** (good code, hermetic builds), it risked failing the academic **stakeholders** (the tutor and examiners) because the documentation lacked the necessary framing. By restructuring this report around accessible analogies (such as the "Jenga Tower" of configuration drift) and translating the technical **domain model** into clear, stakeholder-friendly **requirements** and **use cases**, the documentation now serves as a sufficient deliverable to trace decisions, providing the academic **traceability** required for assessment.
